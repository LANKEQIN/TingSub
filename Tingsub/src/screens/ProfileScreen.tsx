  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <Appbar.Header>
        ...
        >
          <Menu.Item onPress={handleEditProfile} title="编辑资料" leadingIcon="account-edit" />
          <Menu.Item onPress={() => setMenuVisible(false)} title="取消" leadingIcon="close" />
        </Menu>
      </Appbar.Header>
        ...
        <View style={[styles.userInfoCard, { backgroundColor: theme.colors.surface }]}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              ...
              <Text style={[styles.statLabel, { color: theme.colors.textSecondary }]}>订阅数</Text>
            </View>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={[styles.statLabel, { color: theme.colors.textSecondary }]}>月支出</Text>
            </View>
          </View>
        </View>
